...
public class PythonClientCodegen extends AbstractPythonCodegen implements CodegenConfig {
    ...
    public Map<String, ModelsMap> postProcessAllModels(Map<String, ModelsMap> objs) {
        for (ModelsMap modelsMap : objs.values()) {
            for (ModelMap modelMap : modelsMap.getModels()) {
                ...
                List<CodegenProperty> inputNameProperties = generatedProperties(model);
                boolean hidesStorageNames = inputNameProperties.stream().anyMatch(property ->
                ...
                if (hidesStorageNames) {
                    ...
                    configurePublicNameInputs(inputNameProperties);
                    configureHiddenStorageNames(model, inputNameProperties);
                }
                if (hidesStorageNames || inputNameProperties.stream().anyMatch(property ->
                        property.vendorExtensions.containsKey(
    ...
    private static void validateModelPropertyNames(
            CodegenModel model, List<CodegenProperty> generatedProperties) {
        ...
        for (CodegenProperty property : generatedProperties) {
            ...
            if (explicitPublicName
                    ...
                    || generatedMembers.contains(publicName))) {
            ...
            if (explicitPublicName
                    ...
                    || generatedMembers.contains(property.name)
